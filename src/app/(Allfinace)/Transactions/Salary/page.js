...
const Salary = () => {
  ...
  const newdata = { sec_id: "HR123" };
  const newdata1 = { status: "approve", sec_id: "HR123" };
  const newdata2 = { status: "decline", sec_id: "HR123" };
  const newdata3 = { sec_id: "HR123" };
  ...
  const getRequests2 = async (newdata) => {
    ...
    try {
      ...
      const newdataPending = { status: "pending" };
  ...
  const getRequests4 = async (newdata2, newdata3) => { 
    setLoading(true);
    setError(null);
    try {
      console.log("hariiiiiiiiiiiiiiiiii", newdata3);
    ...
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white shadow-md rounded-lg p-4 flex items-center justify-between">
          <h1 className="text-2xl font-semibold text-gray-800">Employee Salary Dashboard</h1>
